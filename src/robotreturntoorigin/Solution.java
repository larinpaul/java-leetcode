...
// There is a robot starting at position (0, 0), the origin, on a 2D place.
...
// to the right once, "L" will always make it move left, etc.
...
// moves have the same magnitude, so it ended up at the origin where
...
public class Solution {
	...
	public static void main(String[] args) {
		...
		System.out.println("Actual: " + solution.judgeCircle(moves1));

		String moves2 = "LL";
		System.out.println("Moves: " + moves2);
		System.out.println("Expected: false");
		System.out.println("Actual: " + solution.judgeCircle(moves2));
		
		String moves3 = "RRDD";
		System.out.println("Moves: " + moves3);
		System.out.println("Expected: false");
		System.out.println("Actual: " + solution.judgeCircle(moves3));
		
		String moves4 = "RLDURLRLUUDDLR";
		System.out.println("Moves: " + moves4);
		System.out.println("Expected: true");
		System.out.println("Actual: " + solution.judgeCircle(moves4));
